...
/**
 * 
 * AndamentoModel è una classe con 6 metodi, questa classe si occupa di gestire varie operazioni di inserimento, modifica e cancellazione delle tuple della tabella andamento. 
 *
 */
public class AndamentoModel {
	...
	/**
	 * Il metodo doSave, viene utilizzato per poter salvare le informazione dell'andamento nel DataBase.
	 ...
	 * @return customers tipo Collection di Andamento, Array che conterrà tutte le informazioni sullo Andamento
	 * @throws SQLException eccezione che viene lanciata quando viene rilevato un errore nell'esecuzione di una query.
	 */
	...
	/**
	 * Il metodo RequestTrend, permette di ricevere tutte le tuple di uno andamento filtrato per id di un tirocinio.
	 * @param order tipo String, variabile che verrà utilizzata nella query per poter specificare un ordine.
	 * @param id tipo Integer, variabile che verrà utilizzate nella query per poter specificare un TirocinioID.
	 * @return trend tipo Collection di Andamento, Array che conterrà tutte le informazioni sullo Andamento
	 * @throws SQLException eccezione che viene lanciata quando viene rilevato un errore nell'esecuzione di una query.
	 */
