...
/**
 * 
 * ProfessoreTutorAziendaleModel è una classe con 11 metodi, questa classe si occupa di gestire varie operazioni di inserimento, modifica e cancellazione delle tuple della tabella professore_tutoraziendale. 
 *
 */
public class ProfessoreTutorAziendaleModel {
	...
	/**
	 * Il metodo doSave, viene utilizzato per poter salvare le informazione del ProfessoreTutorAziendale nel DataBase.
	 * @param professoreTutor tipo ProfessoreTutorAziendale, variabile che ci da accesso a tutti i metodi set e get.
	...
	/**
	 * Il metodo doMdofify, viene utilizzato per poter modificare i dati di un ProfessoreTutorAziendale
	 * @param professoreTutor tipo ProfessoreTutorAziendale, variabile che ci da accesso a tutti i metodi set e get.
	...
	/**
	 * Il metodo doModifyProfile, viene utilizzato per poter modificare il Profilo di un ProfessoreTutorAziendale
	 * @param professoreTutor tipo ProfessoreTutorAziendale, variabile che ci da accesso a tutti i metodi set e get.
	 * @return result tipo int, restituisce il risultato della query di UPDATE.
	 * @throws SQLException eccezione che viene lanciata quando viene rilevato un errore nell'esecuzione di una query.
	 */
	...
	/**
	 * Il metodo doRetrieveByKey restituisce informazioni su un ProfessoreTutorAziendale in base al suo id.
	 * @param id tipo String, variabile che contiente un possibile riferimento ad una tupla in un DataBase
	 * @return bean tipo ProfessoreTutorAziendale, variabile che ci da accesso a tutti i metodi set e get.
	 * @throws SQLException eccezione che viene lanciata quando viene rilevato un errore nell'esecuzione di una query.
	 */
	...
	/**
	 * Il metodo doRetrieveByInternal restituisce informazioni su un Professore in base al suo id.
	 * @param id tipo String, variabile che contiente un possibile riferimento ad una tupla in un DataBase
	 * @return bean tipo ProfessoreTutorAziendale, variabile che ci da accesso a tutti i metodi set e get.
	 * @throws SQLException eccezione che viene lanciata quando viene rilevato un errore nell'esecuzione di una query.
	 */
	...
	/**
	 * Il metodo doRetrieveByInternal restituisce informazioni su un Tutor Aziendale in base al suo id.
	 * @param id tipo String, variabile che contiente un possibile riferimento ad una tupla in un DataBase
	 * @return bean tipo ProfessoreTutorAziendale, variabile che ci da accesso a tutti i metodi set e get.
	 * @throws SQLException eccezione che viene lanciata quando viene rilevato un errore nell'esecuzione di una query.
	 */
	 ...
	 * @return customers tipo Collection di ProfessoreTutorAziendale, Array che conterrà tutte le informazioni dei ProfessoreTutorAziendale
	 * @throws SQLException eccezione che viene lanciata quando viene rilevato un errore nell'esecuzione di una query.
	 */
	...
	/**
	 * Il metodo doRetrieveAllTeachers, permette di ricevere tutti i Professori registrati.
	 * @param order tipo String, variabile che verrà utilizzata nella query per poter specificare un ordine.
	 * @return customers tipo Collection di ProfessoreTutorAziendale, Array che conterrà tutte le informazioni dei ProfessoreTutorAziendale
	 * @throws SQLException eccezione che viene lanciata quando viene rilevato un errore nell'esecuzione di una query.
	 */
	...
	/**
	 * Il metodo loginProfessoreTutor, interroga la tabella professore_tutoraziendale con combinazione email_username, psw
