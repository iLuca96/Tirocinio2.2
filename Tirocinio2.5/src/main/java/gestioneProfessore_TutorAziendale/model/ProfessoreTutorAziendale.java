...
/**
 * 
 * ProfessoreTutorAziendale è una classe con 28 metodi set e get, questa classe è utilizzata per modellare un Professore/ Tutor Aziendale. 
 *
 */
public class ProfessoreTutorAziendale {
	 ...
	 * @param immagine_profilo company String, variabile contente il valore di un immagine_profilo
	 */
