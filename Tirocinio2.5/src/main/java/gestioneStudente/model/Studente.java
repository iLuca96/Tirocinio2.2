...
/**
 * 
 * Studente è una classe con 16 metodi set e get, questa classe è utilizzata per modellare uno Studente. 
 *
 */
public class Studente {
	 ...
	 * @param link_curriculum tipo String, variabile contente il valore di una link_curriculum
	 */
